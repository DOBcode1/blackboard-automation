...
def build_preprocess_prompt(semester_start: str, semester_end: str, term_name: str) -> str:
    ...
    return (
        ...
        "  - Week N = semester_start + (N-1) weeks (computes WHICH week). "
        "Then resolve the day-of-week by this priority order:\n"
        "    1. Explicit Blackboard due date or explicit calendar date in the text — use it; do NOT override with week-number math.\n"
        "    2. Weekday stated or implied in the text (e.g. 'Week 10 Tuesday seminar', 'due in class Thursday') — use THAT weekday of the computed week.\n"
        "    3. Course meeting day from the schedule provided — use the meeting day of the computed week.\n"
        "    4. No weekday available anywhere — output exactly: UNRESOLVED. Set Confidence to 2 or lower. "
        "Do NOT default to Friday or any other fixed weekday.\n"
